...
dataset_list = [
    ...
    ("Steel Plates Faults", "steel-plates-faults"),
    ("Gesture Phase", "GesturePhaseSegmentationProcessed"),
    ("Jungle Chess 2pc", "jungle_chess_2pcs_raw_endgame"),
    ("Banknote Authentication", "banknote-authentication"),
    ("QSAR Biodegradation", "qsar-biodegradation"),
    ("Nursery", "nursery"),
]
...
df.to_csv("classification_results_batch3.csv", index=False)

print("\nBatch-3 complete -> Saved to classification_results_batch3.csv")
