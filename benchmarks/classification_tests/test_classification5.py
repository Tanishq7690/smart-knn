...
dataset_list = [
    ...
    ("Seeds", "seeds"),
    ("Climate Simulation Crashes", "climate-model-simulation-crashes"),
    ("Steel Plates (variant)", "steel-plates-faults"),
]
...
df.to_csv("classification_results_batch5.csv", index=False)

print("\nBatch-5 complete -> Saved to classification_results_batch5.csv")
